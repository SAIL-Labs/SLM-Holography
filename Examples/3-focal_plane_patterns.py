...
total_intensity = 0.75 * np.sum(focal_array)
max_or_set_intensity = True

test_slm.focal_plane_image(focal_array, PSF_pixscale_x, PSF_pixscale_y, total_intensity, max_or_set_intensity = max_or_set_intensity)
